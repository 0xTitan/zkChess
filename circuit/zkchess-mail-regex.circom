...
template ZkChessMailRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[2][i].in[3] <== eq[20][i].out;
		multi_or[2][i].in[4] <== eq[21][i].out;
		multi_or[2][i].in[5] <== eq[22][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		is_substr0[i][1] <== is_substr0[i][0] + states[i+1][23] * states[i+2][24];
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][24] * states[i+2][1];
		is_substr0[i][3] <== is_substr0[i][2] + states[i+1][1] * states[i+2][1];
		is_substr0[i][4] <== is_substr0[i][3] + states[i+1][9] * states[i+2][10];
		is_substr0[i][5] <== is_substr0[i][4] + states[i+1][10] * states[i+2][11];
		is_substr0[i][6] <== is_substr0[i][5] + states[i+1][11] * states[i+2][13];
